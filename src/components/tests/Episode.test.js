...
test("renders the summary test passed as prop", ()=>{
    ...
    // const {getByDisplayValue} = render(<Episode episode={testEpisode} />);
    const summary = screen.queryByText("This is a summary statement");
...
test("renders default image when image is not defined", ()=>{
    ...
    expect(image).toHaveValue("./stranger_things.png");
